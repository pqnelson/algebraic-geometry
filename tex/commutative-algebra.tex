...
\begin{proposition}\mml{tozari1:15}
...
\begin{proposition}[Ideal is prime iff quotient ring is integral domain]\mml{ring_1:18}
...
\begin{proposition}[Quotient ring is a field iff quotient by maximal ideal]\mml{ring_1:21}
Let $R$ be a commutative ring. Let $\mathfrak{p}\ideal R$ be an ideal.
Then $\mathfrak{p}$ is prime iff $R/\mathfrak{p}$ is a field.
\end{proposition}

\begin{proposition}[Maximal ideals of commutative rings are prime]\mml{ring_1}
Let $R$ be a commutative ring.
...
\begin{proposition}[Jacobson radical of a commutative ring]\mml{topzari1:def 14}
...
\begin{proposition}[Radical of ideal is maximal implies quotient by ideal is local]\mml{ideal_2:33}
Let $R$ be a commutative unital nondegenerated ring.
Let $\mathfrak{q}\ideal R$ be a proper ideal of $R$.
If $\Radical{\mathfrak{q}}$ is a maximal ideal,
then $R/\mathfrak{q}$ is a local ring.
\end{proposition}
...
\begin{proposition}[Complement of a prime ideal is a multiplicative set]\mml{ringfrac:def20}\label{prop:commutative-algebra:complement-of-prime-ideal-is-multiplicative-set}
Let $R$ be a ring. Let $P\in\Spec(R)$ be a prime ideal.
Then $U=R\setminus P$ is a multiplicative set.
\end{proposition}

This is defined to be \texttt{Loc(R,P)} in Mizar, and it's registered
as a multiplicatively-closed set there.
...
\begin{definition}[Localization with respect to a prime]\mml{ringfrac:def 21}
...
\begin{proposition}\mml{ringfrac:36}
Let $R$ be a nondegenerate unital commutative ring.
Let $\mathfrak{p}\in\Spec(R)$ be a prime ideal of $R$.
Then $R_{\mathfrak{p}}$ is local and $\mathfrak{p}R_{\mathfrak{p}}$ is
a maximal ideal of $R_{\mathfrak{p}}$.
\end{proposition}
