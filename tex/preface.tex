...
\begin{remark}[Typeset using \TeX]
This is typeset using \TeX, and \MP\ for images. The idea/hope is
that these notes will have some longevity, and \TeX\ provides
stability which \LaTeX\ lacks.
\end{remark}